                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Joao Serra
                            <small><i> Postado a 12 de Dezembro de 2008    </i>
                                <a href="#msg1" data-placement="top" data-toggle="collapse" align="center"><span class="glyphicon glyphicon-pencil"></span> <strong>Edit</strong></a>
                                <a id="ppa_remove" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a>
                            </small>
                        </h4>
                        <p>LCras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.
                            Cras
                            ...
                            <div class="collapse" id="msg1">
                              <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="msg1text">
LCras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus. Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                </textarea>
                                <center>
                                  <div class="col-md-12">
                                    <button type="button" class="btn btn-success btn-sm btn-block">Salvar Alterações</button>
                                  </div>
                                </center>
                                <br>
                              </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">Vendedor
                                        <small><i> Postado a 13 de Dezembro de 2008   </i>
                                            <a href="#msg2" data-placement="top" data-toggle="collapse" align="center"><span class="glyphicon glyphicon-pencil"></span> <strong>Edit</strong></a>
                                            <a id="ppa_remove" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a>
                                        </small>
                                    </h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                      ...
                                      condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                        ...
                                        <div class="collapse" id="msg2">
                                          <div class="form-group">
                                            <label for="msg2text">Editar:</label>
                                            <textarea class="form-control" rows="5" id="msg2text">
Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                            </textarea>
                                            <center>
                                              <div class="col-md-12">
                                                <button type="button" class="btn btn-success btn-sm btn-block">Salvar Alterações</button>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Carlos Neiva
                            <small><i> Postado a 21 de Dezembro de 2012     </i>
                                <a href="#msg3" data-placement="top" data-toggle="collapse" align="center"><span class="glyphicon glyphicon-pencil"></span> <strong>Editar</strong></a>
                                <a id="ppa_remove" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a>
                            </small>
                        </h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                            ...
                            <div class="collapse" id="msg3">
                              <div class="form-group">
                                <label for="msg3text">Editar:</label>
                                <textarea class="form-control" rows="5" id="msg3text">
Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                </textarea>
                                <center>
                                  <div class="col-md-12">
