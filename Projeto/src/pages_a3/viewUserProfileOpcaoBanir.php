    ...
    <div class="row">
      <center>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<button type="button" class="btn btn-danger btn-lg btn-block" data-toggle="modal" data-target="#ordine">Banir</button>
			</div>
		</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <p>Tens a certeza que queres banir este utilizador?</p>
      </div>
